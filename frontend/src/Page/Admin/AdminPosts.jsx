...
const AdminPosts = () => {
  ...
  return (
    <div className="p-4 mx-auto max-w-[1700px]">
      ...
      <div className="mb-4">
        <div className="text-lg font-bold text-gray-600">총 {dummyPosts.length}개의 게시물</div>
      </div>
          ...
          <tbody>
            {dummyPosts.map((post, index) => (
              <tr key={post._id} className="border-b">
                ...
                <td className="px-4 py-3 overflow-hidden overflow-ellipsis whitespace-nowrap max-w-xs">
                  {post.title}
                </td>
                <td className="px-4 py-3 overflow-hidden overflow-ellipsis whitespace-nowrap max-w-xs">
                  {post.content}
